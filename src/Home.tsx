...
export const MintPage = (props: HomeProps) => {
  ...
  useEffect(() => {
    refreshCandyMachineState();
  }, [anchorWallet, props.candyMachineId, props.connection, isEnded, isPresale, refreshCandyMachineState, refreshFlag]);
            ...
            >
              ...
              >
                <img
                  src={nft_image}
                  alt='loading...'
                  style={{width: "100%", borderRadius: 10, boxShadow: "rgba(0, 0, 0, 0.24) 0px 3px 8px"}}
                />
              </Grid>
